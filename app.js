...
var taskInput=document.querySelector(".todo-add__input");//Add a new task.
var addButton=document.querySelector(".button_add");//first button
var incompleteTaskHolder=document.querySelector(".todo__items_active");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".todo__items_done");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="input todo__input";
